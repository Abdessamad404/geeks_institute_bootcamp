...
form.addEventListener("submit", function (event) {
  ...
  const stories = [
    ...
    `In ${values[4]}, a ${values[1]} ${values[0]} named ${values[2]} decided to ${values[3]} for the very first time. The ${values[1]} creature traveled far and wide, eventually discovering that ${values[3]}ing was their true passion!`,
