...
// Display colors with proper ordinal suffixes (1st, 2nd, 3rd, 4th...)
colors.forEach((color, index) => {
    const n = index + 1;
    const suffix = n <= 3 ? ordinal[n] : ordinal[0];
...
// [,,] is a sparse array with 2 empty slots. Spreading it fills them as undefined.
...
// Bonus - Congratulate passed students
students
